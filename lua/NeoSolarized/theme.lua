...
function M.setup()
    ...
    theme.highlights = {
        ...
        Comment                                  = { fg = c.comment_fg, style = options.styles.comments }, -- any comment
        Conceal                                  = { fg = c.bg1 },                                         -- placeholder characters substituted for concealed text (see 'conceallevel')
        CurSearch                                = { link = "IncSearch" },
        CurrentWord                              = { bg = c.hover_yellow },
        ...
        CursorLine                               = { bg = c.bg1 },
        CursorLineNr                             = { fg = c.pink_cursorline_fg, bg = c.bg1, bold = true },
        ...
        IncSearch                                = { bg = c.pink_incsearch, fg = c.pink_incsearch_fg, bold = true },
        ...
        NormalNC                                 = { fg = c.fg0, bg = options.transparent and c.none or c.bg_inactive }, -- normal text in non-current windows
        ...
        PmenuSel                                 = { bg = c.pink_visual, fg = c.pink_incsearch_fg, bold = true },        -- Popup menu: selected item.
        ...
        Search                                   = { bg = c.pink_search, fg = c.pink_search_fg },                        -- Last search pattern highlighting (see 'hlsearch').  Also used for similar items that need to stand out.
        ...
        Function                                 = { fg = c.func_violet, style = options.styles.functions }, -- function name (also: methods for classes)
        ...
        -- Diagnostic
        RedSign                                  = { fg = c.mute_red },
        YellowSign                               = { fg = c.mute_yellow },
        GreenSign                                = { fg = c.mute_green },
        BlueSign                                 = { fg = c.mute_blue },
        VirtualTextWarning                       = { fg = c.mute_yellow },
        VirtualTextError                         = { fg = c.mute_red },
        VirtualTextInfo                          = { fg = c.mute_blue },
        VirtualTextHint                          = { fg = c.mute_green },
        ...
        GitSignsAddNr                            = { fg = c.mute_green },
        GitSignsChangeNr                         = { fg = c.mute_blue },
        GitSignsDeleteNr                         = { fg = c.mute_red },
        ...
        -- BufferLine
        BufferLineIndicatorSelected              = { bg = c.bg0, fg = c.blue, bold = true },
        BufferLineTabSelected                    = { bg = c.bg0, fg = c.fg2, bold = true },
        -- TreesitterContext
        TreesitterContext                        = { bg = c.bg1 },
        -- Blink.cmp
        BlinkCmpMenuSelection                    = { link = "PmenuSel" },
        BlinkCmpLabelMatch                       = { fg = c.pink_cursorline_fg, bold = true },
        -- LSP semantic tokens for functions/methods (override treesitter for consistency)
        ...
        CmpItemKindMethod                        = { fg = c.func_violet },
        CmpItemKindFunction                      = { fg = c.func_violet },
        ...
        NavicIconsMethod                         = { fg = c.func_violet },
        ...
        NavicIconsFunction                       = { fg = c.func_violet },
        ...
        NoiceCompletionItemKindFunction          = { fg = c.func_violet, bg = c.none },
        NoiceCompletionItemKindMethod            = { fg = c.func_violet, bg = c.none },
        ...
        DropBarKindFunction                      = { fg = c.func_violet },
        ...
        DropBarKindMethod                        = { fg = c.func_violet },
